...
OUTPUT_FILE_NAME = os.path.join(
    "scenario_data_files", "scenario_4.csv",
)
...
def run(model, input_db, sim_span, _, baseline_db, ):
    ...
    # Scenario 4 tunes:
        # Add shocks
        # db['res_ipr']               = baseline_db['res_ipr'] + db_asu4['ipr_eviews']
    ...
    db['ipr_eviews']                 = 0
        ...
        #db['res_techl']                = baseline_db['res_techl'] + db_asu4['techl_eviews']
    ...
    db['techl_eviews']                  = 0
        ...
        #db['res_finc']                = baseline_db['res_finc'] + db_asu4['finc_eviews']
